# Proyecto basado en el ejemplo Backbone de TodoMVC

## Pasos seguidos
Copiar la carpeta Backbone de todomvc/examples

Instalar dependencias
npm install

Crear la carpeta css
Añadir los estilos personalizados en app.css

Incluir los css personalizados
